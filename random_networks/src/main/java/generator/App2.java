...
public class App2 {
	...
	public static void main(String... args) {
		...
		Stream.of("8203", "9202", "9210", "4150", "2103", "2152",
				"5033")
		.parallel()
		...
		.map(entry -> {
			var entriesbyBusLine = rtService.getEntriesbyBusLine(entry.headsign());
		...
		.forEach(lineTripRecord -> {
					...
					try {
						GPX.write(gpx, Paths.get("./pontos_%s.gpx".formatted(lineTripRecord.line)));
					} catch (IOException e) {
						e.printStackTrace();
					}
				})
